...
namespace TraversingLabyrinthsInDepth
{
    enum State
    {
        Empty,
    ...
    public class Program
    {
        ...
        static void Main()
        {
            ...
            //Traversing via Stack...change Stack to Queue to change Traversing type to bypassing wide
            ...
            Print(map);
            //Visit(map, 0, 0); Traversing via recursion calls..bad idea, because of possible Stack Overflow Exception
        }
